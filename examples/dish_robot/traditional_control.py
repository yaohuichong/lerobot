...
class JointRecorder:
    ...
    def log(self, positions: dict):
        if self.log_file:
            ...
            values = [positions.get(m, 0.0) for m in ["shoulder_pan", "shoulder_lift", "elbow_flex", "wrist_flex", "wrist_roll", "gripper"]]
...
class TraditionalController:
    ...
    def demo_scoop_motion(self):
        ...
        home = {"shoulder_pan": 0, "shoulder_lift": 0, "elbow_flex": 0, "wrist_flex": 0, "wrist_roll": 0, "gripper": 50}
        ready = {"shoulder_pan": 0, "shoulder_lift": -30, "elbow_flex": 45, "wrist_flex": 20, "wrist_roll": 0, "gripper": 80}
        scoop_start = {"shoulder_pan": 0, "shoulder_lift": -45, "elbow_flex": 60, "wrist_flex": 30, "wrist_roll": 0, "gripper": 100}
        scoop_end = {"shoulder_pan": 0, "shoulder_lift": -20, "elbow_flex": 30, "wrist_flex": 10, "wrist_roll": 0, "gripper": 30}
            ...
            try:
                ...
                if cmd == "quit" or cmd == "q":
                    ...
                    if len(parts) == 7:
                        ...
                        target = dict(zip(self.motor_names, values))
                        self.move_to_position(target, duration=1.0)
                    else:
                        print("Usage: goto <shoulder_pan> <shoulder_lift> <elbow_flex> <wrist_flex> <wrist_roll> <gripper>")
