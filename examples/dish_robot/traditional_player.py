...
def convert_all_txt_to_json(log_dir: str = "joint_logs"):
    ...
    for i in range(1, 100):
        ...
        if os.path.exists(txt_path):
            ...
            print(f"  Steps: {json_data['metadata']['total_steps']}, Duration: {json_data['metadata']['duration_s']}s")
...
def main():
    ...
    parser.add_argument("--log-dir", type=str, default="/home/nvidia/lerobot/examples/dish_robot/joint_logs", help="Log directory")
